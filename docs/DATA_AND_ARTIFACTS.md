...
This repository does not redistribute raw ISIC 2019 or BCN20000 images. The user must download the images from the original dataset releases.
...
To fully rerun the case study, place the datasets and checkpoint under the paths specified in the config files or update those paths locally.
